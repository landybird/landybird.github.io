---
title: typer的源码                                              
description: 第三方package`typer`的源码
categories:
- python
tags:
- python   
...
`Typer` build great CLIs. Easy to code. Based on Python `type hints` + [click](https://click.palletsprojects.com/en/7.x/)




[fastapi](https://fastapi.tiangolo.com/)作者[tiangolo](https://github.com/tiangolo)写的一个简易命令行操作的库
